...
extern bool hyundai_kona_ev_torque;
bool hyundai_kona_ev_torque = false;
...
void hyundai_common_init(uint16_t param) {
  ...
  const uint16_t HYUNDAI_PARAM_KONA_EV_TORQUE = 1024;
  ...
  hyundai_kona_ev_torque = GET_FLAG(param, HYUNDAI_PARAM_KONA_EV_TORQUE);
